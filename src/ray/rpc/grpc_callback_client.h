...
using AsyncUnaryMethod = void (
    GrpcService::StubInterface::experimental_async_interface::*)(
    grpc::ClientContext *context, const Request *request, Reply *response, ReplyCallback);

template <class GrpcService, class Request, class Reply>
using AsyncClientStreamingMethod =
    void (GrpcService::StubInterface::experimental_async_interface::*)(
        grpc::ClientContext *context, Reply *response,
        grpc::experimental::ClientWriteReactor<Request> *reactor);

template <class GrpcService, class Request, class Reply>
using AsyncServerStreamingMethod =
    void (GrpcService::StubInterface::experimental_async_interface::*)(
        grpc::ClientContext *context, Request *request,
        grpc::experimental::ClientReadReactor<Reply> *reactor);

template <class GrpcService, class Request, class Reply>
using AsyncBidiStreamingMethod =
    void (GrpcService::StubInterface::experimental_async_interface::*)(
        grpc::ClientContext *context,
        grpc::experimental::ClientBidiReactor<Request, Reply> *reactor);
  ...
  void METHOD(const METHOD##Request &request,                                   \
    ...
    rpc_client->CallUnaryMethod<METHOD##Request, METHOD##Reply>(                \
        static_cast<AsyncUnaryMethod<SERVICE, METHOD##Request, METHOD##Reply>>( \
            &SERVICE::Stub::experimental_async::METHOD),                        \
...
#define CLIENT_STREAMING_REACTOR_RPC_CLIENT_METHOD(METHOD, rpc_client, SPECS)          \
  void METHOD(grpc::ClientContext *ctx, METHOD##Reply *reply,                          \
              grpc::experimental::ClientWriteReactor<METHOD##Request> reactor) SPECS { \
    return rpc_client->GetStub()->experimental_async()->METHOD(ctx, reply, reactor);   \
  }
...
#define SERVER_STREAMING_REACTOR_RPC_CLIENT_METHOD(METHOD, rpc_client, SPECS)          \
  void METHOD(grpc::ClientContext *ctx, METHOD##Request *request,                      \
              grpc::experimental::ClientReadReactor<METHOD##Reply> reactor) SPECS {    \
    return rpc_client->GetStub()->experimental_async()->METHOD(ctx, request, reactor); \
  }
...
#define BIDI_STREAMING_REACTOR_RPC_CLIENT_METHOD(METHOD, rpc_client, SPECS)          \
  void METHOD(                                                                       \
      ...
      grpc::experimental::ClientBidiReactor<METHOD##Request, METHOD##Reply> reactor) \
      SPECS {                                                                        \
    return rpc_client->GetStub()->experimental_async()->METHOD(ctx, reactor);        \
  }
...
template <class GrpcService, class Request, class Reply>
class ClientWriterReactor : public grpc::experimental::ClientWriteReactor<Request> {
 public:
...
class GrpcCallbackClient {
 public:
  ...
  ClientStreamingWriter<GrpcService, Request, Reply> CallClientStreamingMethod(
    ...
    (stub_->experimental_async()->*method)(ctx.get(), &reactor->reseponse_, reactor);
